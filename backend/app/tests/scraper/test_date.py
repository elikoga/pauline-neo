...
def test_date():
    ...
    assert date == datetime.datetime(day=12, month=8, year=2021, hour=9, minute=0)


def test_date_24Uhr():
    date = parse_date("Do, 12. Aug. 2021", "24:00")
    assert date == datetime.datetime(day=12, month=8, year=2021, hour=23, minute=59)
...
def test_months():
    ...
    for month, month_index in months.items():
        ...
        assert date == datetime.datetime(day=12, month=month_index, year=2021, hour=11, minute=00)
